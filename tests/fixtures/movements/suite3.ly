\version "2.24.0"
% Three short original movements in one PDF, flowing on the same page.
% Each \score has its own key, meter and tempo. Ground-truth MIDI:
% suite3.midi (I), suite3-1.midi (II), suite3-2.midi (III).
...
\score {
  ...
  \new PianoStaff <<
    \new Staff { \clef treble \key c \major \time 4/4 \tempo 4 = 96
      c'4 e' g' e' | f'4 a' g'2 | e'4 g' c'' b' | a'4 f' g'2 |
...
\score {
  ...
  \new PianoStaff <<
    \new Staff { \clef treble \key f \major \time 3/4 \tempo 4 = 132
      f'4 a' c'' | bes'4 a' g' | a'8 bes' c''4 f' | e'2. |
...
\score {
  ...
  \new PianoStaff <<
    \new Staff { \clef treble \key d \major \time 6/8 \tempo 4. = 80
      d'8 fis' a' d''4 a'8 | b'8 a' g' fis'4 e'8 | d'8 fis' a' b'4 a'8 | g'8 e' cis' e'4. |
